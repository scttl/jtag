 function w = ltc3_create_lr_weights(samples, fnames, sigma, maxevals, outfile)
% LTC3_CREATE_LR_WEIGHTS   Builds up a struct containing coefficient weights 
%                         for use in a logistical regression classifier.
%
%   W = CREATE_LR_WEIGHTS(SAMPLES, FNAMES, [SIGMA, ITERATIONS, OUTFILE])  
%   Attempts to  build up and
