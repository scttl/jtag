...
fprintf('For nips:\n');
nips = test_set('./features/nips-train-nomarks.knn.mat', ...
                './features/nips-test-nomarks.knn.mat', ...
                './memm/memm-nips.memm.mat', ...
                './memm/memm-nips-results.mat');

fprintf('For jmlr:\n');
jmlr = test_set('./features/jmlr-train-nomarks.knn.mat', ...
                './features/jmlr-test-nomarks.knn.mat', ...
