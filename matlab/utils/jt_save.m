function res = jt_save(s)
% JT_SAVE       Formats and writes out the contents of the structure S to a
%               jtag and jlog file.
%
...
% CVS INFO %
%%%%%%%%%%%%
% $Id: jt_save.m,v 1.1 2004-07-02 17:08:27 klaven Exp $
% 
% REVISION HISTORY:
% $Log: jt_save.m,v $
% Revision 1.1  2004-07-02 17:08:27  klaven
% A few functions to make it easier to look at tagging info using Matlab, rather than the JTAG program.
%
